...
int main(void)
{
  ...
  while (1)
  {
	...
	__HAL_TIM_SetCompare(&htim3, TIM_CHANNEL_3, CCR); //Sets pulse width modulation using CCR value
...
uint32_t pollADC(void){
  // TODO: Complete function body to get ADC val
	...
	HAL_ADC_PollForConversion(&hadc, HAL_MAX_DELAY);//Checks if ADC Conversion has completed
